...
const SPY_PROTOCOL_CUSTOM = 0;
const SPY_PROTOCOL_CAN = 1;
const SPY_PROTOCOL_GMLAN = 2;
const SPY_PROTOCOL_J1850VPW = 3;
const SPY_PROTOCOL_J1850PWM = 4;
const SPY_PROTOCOL_ISO9141 = 5;
const SPY_PROTOCOL_Keyword2000 = 6;
const SPY_PROTOCOL_GM_ALDL_UART = 7;
const SPY_PROTOCOL_CHRYSLER_CCD = 8;
const SPY_PROTOCOL_CHRYSLER_SCI = 9;
const SPY_PROTOCOL_FORD_UBP = 10;
const SPY_PROTOCOL_BEAN = 11;
const SPY_PROTOCOL_LIN = 12;
...
{
	//transmit message
	unsigned short vs_netid;				/* not supported*/

	unsigned short padding;				/* not supported*/
	...
	unsigned short    fc_ext_address_enable; 	/* not supported*/
	unsigned short    fc_ext_address;			/* not supported*/


	//flow control timeouts
	unsigned short    fs_timeout;				/* not supported*/
	unsigned short    fs_wait;				/* not supported*/
